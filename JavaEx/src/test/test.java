...
class extExtends extends calculator{
	public void min() {
		System.out.println(left - right);
	}
}

class interTest implements interfaceTest{

	@Override
	public int sum() {
		System.out.println("interface 테스트 sum()");
		return 0;
	}

	@Override
	public int min() {
		System.out.println("interface 테스트 min()");
		return 0;
	}
...
public class test {
	...
	public static void main(String[] args) {
		...
		extExtends ex1 = new extExtends();
		ex1.setOperand(10,10);
		ex1.sum();
		ex1.min();
		
		interTest in1 = new interTest();
		in1.sum();
		in1.min();
	}
}*/
